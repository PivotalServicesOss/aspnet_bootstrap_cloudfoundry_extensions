intellisense.annotate(jQuery, {
  ...
  'boxModel': function() {
    /// <summary>Deprecated in jQuery 1.3 (see jQuery.support). States if the current page, in the user's browser, is being rendered DefaultAndConfigServer the W3C CSS Box Model.</summary>
  ...
  'get': function() {
    /// <signature>
    ///   <summary>Load data from the server DefaultAndConfigServer a HTTP GET request.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
  ...
  'getJSON': function() {
    /// <signature>
    ///   <summary>Load JSON-encoded data from the server DefaultAndConfigServer a GET HTTP request.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
  ...
  'getScript': function() {
    /// <signature>
    ///   <summary>Load a JavaScript file from the server DefaultAndConfigServer a GET HTTP request, then execute it.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
  ...
  'isPlainObject': function() {
    /// <signature>
    ///   <summary>Check to see if an object is a plain object (created DefaultAndConfigServer "{}" or "new Object").</summary>
  ...
  'post': function() {
    /// <signature>
    ///   <summary>Load data from the server DefaultAndConfigServer a HTTP POST request.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
    ///   <param name="data" type="">A plain object or string that is sent to the server with the request.</param>
...
intellisense.annotate(jQuery.fn, {
  ...
  'die': function() {
    /// <signature>
    ///   <summary>Remove event handlers previously attached DefaultAndConfigServer .live() from the elements.</summary>
  ...
  'unbind': function() {
    ...
    ///   <summary>Remove a previously-attached event handler from the elements.</summary>
    ///   <param name="eventType" type="String">A string containing a JavaScript event type, such as click or submit.</param>
    ///   <param name="false" type="Boolean">Unbinds the corresponding 'return false' function that was bound DefaultAndConfigServer .bind( eventType, false ).</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove a previously-attached event handler from the elements.</summary>
