...
namespace PivotalServices.AspNet.Bootstrap.Extensions.Cf.Logging.Tests.Extensions
{
    public class AppBuilderExtensionsTests
    {
        ...
        public void Test_AddConsoleSerilogLogging_WithoutCorrelation()
        {
            ...
            Assert.Contains(TestProxy.HandlersProxy, h => h.FullName == "PivotalServices.AspNet.Bootstrap.Extensions.Cf.Logging.Handlers.GlobalErrorHandler");
        ...
        public void Test_AddConsoleSerilogLogging_WithCorrelation()
        {
            ...
            Assert.Contains(TestProxy.HandlersProxy, h =>h.FullName == "PivotalServices.AspNet.Bootstrap.Extensions.Cf.Logging.Handlers.GlobalErrorHandler");
            Assert.Contains(TestProxy.HandlersProxy, h =>h.FullName == "PivotalServices.AspNet.Bootstrap.Extensions.Cf.Logging.Handlers.ScopedLoggingHandler");
            Assert.Contains(TestProxy.HandlersProxy, h =>h.FullName == "PivotalServices.AspNet.Bootstrap.Extensions.Cf.Logging.Handlers.InboundBeginRequestObserverHandler");
            Assert.Contains(TestProxy.HandlersProxy, h =>h.FullName == "PivotalServices.AspNet.Bootstrap.Extensions.Cf.Logging.Handlers.InboundEndRequestObserverHandler");
            Assert.Contains(TestProxy.HandlersProxy, h =>h.FullName == "PivotalServices.AspNet.Bootstrap.Extensions.Cf.Logging.Handlers.InboundErrorRequestObserverHandler");
